<%-- 
    Document   : otel_page_reservation_2
    Created on : 24 Ara 2023, 01:18:01
    Author     : Monster
--%>
...
<div style='margin: 2%;border: 1px solid #20c997;padding: 2%;border-radius: 2%;box-shadow: 1px 3px 7px 0px rgba(0, 0, 0, 2.3);  margin-bottom: 10%;'>
    ...
    <%
        //ODA ID ALINDI SESSIONDAN
        String allRoomIDs = (String) user_session.getHotel_roomsID();
        String[] roomIDsArray = new String[0];

        
        if (allRoomIDs != null && !allRoomIDs.isEmpty()) {
            roomIDsArray = allRoomIDs.split(",");
            for (String roomID : roomIDsArray) {
               // out.println("Room ID: " + roomID + "<br>");
            }
        } else {
            out.println("allRoomIDs Boş!");
        }
    %>
    ...
    <%
              ...
              if (childrenYearParam != null && !childrenYearParam.isEmpty()) {
    ...
    <div class=row>
        <div class="col-md-6">
            <div class="row justify-content-center">
                <div class="col-md-12">   <div class="card border-warning mb-3 mx-auto" style="width: 100%; margin:1%;">
                        ...
                        <div class="card-body">
                            ...
                            <%
                                  if (roomDetails.containsKey("child_number") && roomDetails.get("child_number") != null) 
                                  {
                                       ...
                                       {
                                              childYearInt_ = Integer.parseInt(childYear);
                                              age_ = currentDate.getYear() - childYearInt_;
   
                                       } 
                            %>
                            <h6 class="card-text"><%=i%>. Çocuk Doğum Tarihi: <%=childYear %>, <strong>Yaşı: <%=age_ %></strong></h6>
                            <%
                                       }
                                   }
                                     out.println("<br>");
                    ...
                    <div class="card border-danger mb-3 mx-auto" style="width: 100%; margin:1%;">
                        ...
                        <div class="card-body ">
                            ...
                            //-------------------ERKEN REZERVASYON İNDİRİMİ------------------------------------------
                              ...
                              if (check_in_date != null && !check_in_date.isEmpty()) {
                          ...
                          if (roomDetailsList != null) 
                          {
                            for (Map<String, String> roomDetails2 : roomDetailsList) // oda sayısı kadar dönecek 
                             ...
                             int person_number=Integer.parseInt(roomDetails2.get("person_number"));
                             personPrices= person_number*user_session.getRoom_price(); //her oda için yetişkin fiyatı 
